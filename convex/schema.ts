...
export default defineSchema({
  ...
  contentPackages: defineTable({
    ...
    narrative: v.string(),
    package: v.any(),
    visualOpportunity: v.optional(v.any()),
    demoVideoOpportunity: v.optional(v.any()),
    visualBrief: v.optional(v.any()),
    demoVideoPlan: v.optional(v.any()),
    visualVideoQuality: v.optional(v.any()),
    generatedAssets: v.optional(v.array(v.any())),
    executionReadyVariants: v.optional(v.array(v.any())),
    xProseContract: v.optional(v.any()),
    evaluations: v.any(),
    createdAt: v.string(),
    updatedAt: v.string(),
  })
