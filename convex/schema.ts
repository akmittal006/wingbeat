...
export default defineSchema({
  ...
  contentPackages: defineTable({
    ...
    narrative: v.string(),
    package: v.any(),
    visualOpportunity: v.any(),
    demoVideoOpportunity: v.any(),
    visualBrief: v.any(),
    demoVideoPlan: v.any(),
    visualVideoQuality: v.any(),
    generatedAssets: v.array(v.any()),
    executionReadyVariants: v.array(v.any()),
    xProseContract: v.any(),
    evaluations: v.any(),
    createdAt: v.string(),
    updatedAt: v.string(),
  })
